...
document.addEventListener("stateUpdated", function() {
    ...
    if (!isMobile) {
        ...
        pipGUIContainer.style.display = 'flex';
    }
    ...
    setTimeout(() => {
        ...
        if (!(isMobile)) {
            ...
            pipGUIContainer.style.opacity = '1';
            ...
            setTimeout(() => {
                ...
                pipGUIContainer.style.transition = 'opacity 0.25s ease-in-out, background-color 0.25s ease';
            }, 1000)
        }
    }, 1000)
    ...
    document.getElementById('pipGUIContainer').addEventListener('click', async function() {
        // trigger pip window
    });
